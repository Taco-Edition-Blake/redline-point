...
class Opponent {
  ...
  update(dt){
    ...
    this.groundY = getGroundHeight(this.pos.x, this.pos.z, this.groundY || 0);
    this.root.position.set(this.pos.x, this.groundY + this.hopY, this.pos.z);
  ...
  hitBox(){
    const y0 = (this.groundY || 0) + this.hopY;
